...
OBJS=amazon.o mydatastore.o user.o db_parser.o product_parser.o product.o book.o clothing.o movie.o util.o 
...
amazon.o: amazon.cpp db_parser.h mydatastore.h product_parser.h util.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c amazon.cpp
mydatastore.o: mydatastore.cpp user.h util.h product.h mydatastore.h
